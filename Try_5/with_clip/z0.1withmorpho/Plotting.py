...
def RedBlueplot():
		...
		mask,or_fitted_model = or_fit(g_init, SM, g_minus_r)
...
def Ellipticity():
	...
	t, p = ttest_ind(Groups['ellip'], Field['ellip'], equal_var=False)
	print("ttest_ind, G,F:            t = %g  p = %g" % (t, p))
	t, p = ttest_ind(Groups['ellip'], Fil['ellip'], equal_var=False)
	print("ttest_ind, G, Fil:            t = %g  p = %g" % (t, p))
	t, p = ttest_ind(Fil['ellip'], Field['ellip'], equal_var=False)
	print("ttest_ind, Fil, F:            t = %g  p = %g" % (t, p))
