...
Available_data = ascii.read('DATA_FOR_ANALYSIS_WITHOUT_QUERRY.csv',\
	names=['id','SM','VelDisp','SFR','GM','Tot_Mass','SM_sh','Metal','SF_Metal',\
	'NSF_Metal','SF_O','SF_Fe','SF_N','SF_C','SF_H','NSF_O','NSF_H','Stars_O','Stars_N',\
	'Stars_C','Stars_Fe','Stars_H','x','y','z','SubGrpNum','Vel','Mass_sh','grpid','u','g','r',\
	'i','zmag','Y','J','H','K','M_dot','ellip','Kappacorot'])
...
for i in range(1,numslice+1):
	...
	Data_all_env = pd.concat(f,sort=True).reset_index(drop=True)
